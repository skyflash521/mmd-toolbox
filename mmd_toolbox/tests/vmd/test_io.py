"""vmd-io のテスト(vmd-io.md §8 テスト要件1〜6)。

フィクスチャは宣言的リテラルのみ(tests/data/README.md):
- io層: フォーマット仕様書(docs/specs/vmd/VMD_file_format.md)から手書きしたバイト列
- 正規化: データモデルの直接構築
"""
