...
def _camera_reduce_source():
    ...
    from mmd_toolbox.vmd.reduce import Tolerances
...
def _camera_track(source, tols, n):
    from mmd_toolbox.vmd.reduce import reduce_camera_track
...
def test_reduce_bezier_within_tol_fov_position_rotation():
    ...
    from mmd_toolbox.vmd.reduce import verify_camera_track
