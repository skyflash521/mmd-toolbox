...
トラックに分割する。サンプリングは mmd_toolbox.vmd.interp に委譲する:
...
from sparsevmd.sample import build_tracks, perspective_series, sample_rotation, sample_scalar
...
def test_sample_scalar_honors_interpolation_curve():
    ...
    # 評価した値になること(§5.1 は mmd_toolbox.vmd.interp へ委譲)。
